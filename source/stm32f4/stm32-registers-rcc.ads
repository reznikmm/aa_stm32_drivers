...
package STM32.Registers.RCC is
   ...
   type CIR_Register is record
      ...
      PLLI2SRDYC     : Boolean;
      --  unspecified
      Reserved_22_22 : Interfaces.Unsigned_32 range 0 .. 1;
   ...
   type AHB1RSTR_Register is record
      ...
      GPIOIRST       : Boolean;
      --  unspecified
      Reserved_9_11  : Interfaces.Unsigned_32 range 0 .. 7;
      --  CRC reset
      CRCRST         : Boolean;
      --  unspecified
      ...
      DMA2RST        : Boolean;
      --  unspecified
      Reserved_23_24 : Interfaces.Unsigned_32 range 0 .. 3;
      --  Ethernet MAC reset
      ETHMACRST      : Boolean;
      --  unspecified
   ...
   type Boolean_Array_7 is array (STM32.PA .. STM32.PG) of Boolean
     with Component_Size => 1, Size => 7;

   --  AHB1 peripheral clock register
   type AHB1ENR_Register is record
      --  IO port A..G clock enable
      GPIOxEN        : Boolean_Array_7;
      ...
      BKPSRAMEN      : Boolean;
      --  unspecified
      Reserved_19_20 : Interfaces.Unsigned_32 range 0 .. 3;
      --  DMA1 clock enable
      DMA1EN         : Boolean;
      --  DMA2 clock enable
      DMA2EN         : Boolean;
   ...
   type PLLI2SCFGR_Register is record
      ...
      --  unspecified
      Reserved_15_27 : Interfaces.Unsigned_32 range 0 .. 8191;
