...
private with STM32.DMA.Stream_2_2;
private with STM32.DMA.Stream_2_7;

generic
   Priority : System.Any_Priority;
   --  Priority is used for underlying protected object.
package STM32.UART.DMA_USART_1 is
   ...
   procedure Configure
     ...
     with Pre =>
       ...
       RX in (PA, 10) | (PB, 7);
   --
   --  Configure USART_1 on given pins and speed (baud rate)
...
private
   ...
   package Stream_2_2 is new STM32.DMA.Stream_2_2 (Priority);
   package Stream_2_7 is new STM32.DMA.Stream_2_7 (Priority);

   package Implementation is new DMA_Implementation
     (STM32.Registers.USART.USART1_Periph,
      UART_1_3,
      Channel   => 4,
      Interrupt => Ada.Interrupts.Names.USART1_Interrupt,
      Priority  => Priority,
      RX_Stream => Stream_2_2.Stream,
      TX_Stream => Stream_2_7.Stream);

end STM32.UART.DMA_USART_1;