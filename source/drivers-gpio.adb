...
package body Drivers.GPIO is
   ...
   procedure Clear_Interrupt (Pin : Drivers.Pin) is
   ...
   procedure Configure_Output (Pin : Drivers.Pin) is
   begin
      Enable_GPIO (Pin.Port);
   ...
   procedure Enable_GPIO (Port : Drivers.Port) is
