...
package STM32.UART.DMA_USART_3 is
   ...
   --
   --  Configure USART_3 on given pins and speed (baud rate)
...
private
   ...
   package Stream_1_1 is new STM32.DMA.Stream_1_1 (Priority);
   ...
   package Implementation is new DMA_Implementation
     (STM32.Registers.USART.USART3_Periph,
      UART_1_3,
      Channel   => 4,
      Interrupt => Ada.Interrupts.Names.USART3_Interrupt,
      Priority  => Priority,
      RX_Stream => Stream_1_1.Stream,
      TX_Stream => Stream_1_3.Stream);

end STM32.UART.DMA_USART_3;
