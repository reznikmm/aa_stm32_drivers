...
package STM32.Timer.Polling_TIM_3 is
   ...
   procedure Setup
     (Slave_Mode    : Timer.Slave_Mode_Kind := Disabled;
      Trigger_Input : Polling_TIM_3.Trigger_Input := (others => <>);
...
private
   ...
   package Implementation is new Generic_Polling_Implementation
     (Periph => STM32.Registers.TIM.TIM3_Periph);
