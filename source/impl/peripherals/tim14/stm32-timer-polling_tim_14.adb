...
package body STM32.Timer.Polling_TIM_14 is
   ...
   begin
      STM32.Registers.RCC.RCC_Periph.APB1ENR.TIM_EN_12_14 (14) := True;
      STM32.Registers.RCC.RCC_Periph.APB1RSTR.TIM_EN_12_14 (14) := True;
      STM32.Registers.RCC.RCC_Periph.APB1RSTR.TIM_EN_12_14 (14) := False;
...
end STM32.Timer.Polling_TIM_14;
