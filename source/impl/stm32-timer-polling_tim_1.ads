...
package STM32.Timer.Polling_TIM_1 is
   ...
   subtype Master_Timer is Positive
     with Static_Predicate => Master_Timer in 2 | 3 | 4 | 5;
   ...
   --
   --  * Control_Update -
   --    Generates an Capture/Compare control update event.
   --
   --  * Break -
   --    Generates a break event.
   --
   --  * Compare_Capture (x) -
...
private
   ...
   package Implementation is new Generic_Polling_Implementation
     (Periph => STM32.Registers.TIM.TIM1_Periph);
