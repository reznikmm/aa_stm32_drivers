...
package body STM32.Timer.Polling_TIM_5 is
   ...
   begin
      STM32.Registers.TIM.TIM5_Periph.ARR := Value;
   ...
   begin
      STM32.Registers.TIM.TIM5_Periph.CCR (Channel) := Value;
   end Set_Compare_Value;

   procedure Set_Counter (Value : Interfaces.Unsigned_32) is
   begin
      STM32.Registers.TIM.TIM5_Periph.CNT := Value;
   end Set_Counter;
