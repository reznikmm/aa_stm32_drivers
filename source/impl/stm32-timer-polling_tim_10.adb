...
package body STM32.Timer.Polling_TIM_10 is
   ...
   begin
      STM32.Registers.RCC.RCC_Periph.APB2ENR.TIM10EN := True;
      STM32.Registers.RCC.RCC_Periph.APB2RSTR.TIM10RST := True;
      STM32.Registers.RCC.RCC_Periph.APB2RSTR.TIM10RST := False;
...
end STM32.Timer.Polling_TIM_10;
