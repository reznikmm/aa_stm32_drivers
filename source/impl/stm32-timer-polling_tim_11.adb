...
package body STM32.Timer.Polling_TIM_11 is
   ...
   begin
      STM32.Registers.RCC.RCC_Periph.APB2ENR.TIM11EN := True;
      STM32.Registers.RCC.RCC_Periph.APB2RSTR.TIM11RST := True;
      STM32.Registers.RCC.RCC_Periph.APB2RSTR.TIM11RST := False;
